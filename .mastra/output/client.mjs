...
import pg from 'pg';
import { pgTable, timestamp, varchar, text, integer, boolean, numeric, serial, decimal, json } from 'drizzle-orm/pg-core';
...
const trustLayerHallmarks = pgTable("trust_layer_hallmarks", {
  id: serial("id").primaryKey(),
...
const trustStamps = pgTable("trust_stamps", {
  id: serial("id").primaryKey(),
  userId: varchar("user_id", { length: 255 }),
...
const hallmarkCounter = pgTable("hallmark_counter", {
  id: text("id").primaryKey(),
  currentSequence: text("current_sequence").notNull().default("0")
});
const userUniqueHashes = pgTable("user_unique_hashes", {
  userId: varchar("user_id", { length: 255 }).primaryKey(),
...
var schema = /*#__PURE__*/Object.freeze({
  ...
  gasPrices: gasPrices,
  hallmarkCounter: hallmarkCounter,
...
export { webauthnCredentials as $, tradeExecutions as A, dailyRiskSnapshots as B, tradingMilestones as C, userWallets as D, snipePresets as E, snipeOrders as F, snipeExecutions as G, sniperSessionStats as H, referrals as I, dustBusterHistory as J, dustBusterStats as K, quantTradeActions as L, quantTradeSessions as M, multisigVaults as N, vaultSigners as O, vaultProposals as P, vaultActivityLog as Q, proposalVotes as R, pageViews as S, apiKeys as T, apiRequestLogs as U, apiUsageDaily as V, apiSubscriptions as W, traderProfiles as X, copyTradingSubscriptions as Y, communitySignals as Z, signalVotes as _, sessions as a, webauthnChallenges as a0, ecosystemApps as a1, portfolioWallets as a2, portfolioHoldings as a3, portfolioTransactions as a4, portfolioSnapshots as a5, priceAlerts as a6, whaleAlerts as a7, smartMoneyWallets as a8, whaleTransactions as a9, notificationLogs as aa, notificationChannels as ab, cryptoEvents as ac, tokenUnlocks as ad, airdropTracking as ae, userEventReminders as af, defiPositions as ag, defiProtocols as ah, yieldOpportunities as ai, tokenHolderStats as aj, tokenFlows as ak, dexVolumeStats as al, gasPrices as am, referralCodes as an, referralAttributions as ao, referralPayouts as ap, socialProfiles as aq, socialFollows as ar, tradingSignals as as, API_SCOPES as at, schema as au, client as av, auditEvents as b, hallmarkMints as c, db as d, predictionFeatures as e, predictionModelVersions as f, systemConfig as g, hallmarkProfiles as h, predictionOutcomes as i, predictionAccuracyStats as j, strikeagentPredictions as k, strikeagentOutcomes as l, limitOrders as m, autoTradeConfig as n, autoTrades as o, predictionEvents as p, strikeAgentSignals as q, quantScanConfig as r, subscriptions as s, quantLearningMetrics as t, userUsage as u, exchangeConnections as v, exchangeOrders as w, exchangeBalanceSnapshots as x, tradingProfiles as y, tradeSuggestions as z };
