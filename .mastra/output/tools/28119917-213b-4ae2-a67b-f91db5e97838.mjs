...
const glossary = {
  RSI: {
    ...
    howToUse: "RSI below 30 = OVERSOLD (potential buying opportunity - price may bounce). RSI above 70 = OVERBOUGHT (consider taking profits - correction likely). RSI 40-60 = neutral zone. Watch for divergence: if price makes new lows but RSI doesn't, that's a bullish signal suggesting the downtrend is weakening.\n\n\u{1F3AF} COMBINING RSI WITH OTHER SIGNALS (Higher Accuracy):\n\u2022 RSI <30 + Price at Support + Volume spike = STRONG BUY (triple confirmation)\n\u2022 RSI >70 + Price at Resistance + MACD bearish cross = STRONG SELL\n\u2022 RSI <30 + MACD bullish cross + Price above EMA 50 = Buy the dip in uptrend\n\u2022 RSI divergence + Bollinger Band squeeze breaking up = High probability breakout\n\u2022 RSI 40-60 + Price between EMAs = WAIT, no clear signal\n\nNever trade on RSI alone - always confirm with at least 2 other indicators."
  },
  MACD: {
    ...
    howToUse: "BULLISH SIGNALS: MACD crosses above signal line (buy signal), histogram turns positive, MACD crosses above zero line. BEARISH SIGNALS: MACD crosses below signal line (sell signal), histogram turns negative, MACD crosses below zero. Larger histogram bars = stronger momentum. Watch for MACD/price divergence - if price makes new highs but MACD doesn't, trend may be weakening.\n\n\u{1F3AF} COMBINING MACD WITH OTHER SIGNALS:\n\u2022 MACD bullish cross + RSI rising from <40 + Volume increasing = High conviction buy\n\u2022 MACD above zero + Price above EMA 50 & 200 + Rising volume = Strong uptrend, hold position\n\u2022 MACD bearish cross + RSI >70 + Price at resistance = Take profits\n\u2022 MACD histogram shrinking + RSI divergence = Trend exhaustion, prepare to exit\n\u2022 MACD flat + RSI 40-60 + Low volume = Consolidation, wait for breakout\n\nBest used with RSI and volume for confirmation. MACD alone can give false signals in choppy markets."
  },
  EMA: {
  ...
  "MARKET CAP": {
    definition: "Market Capitalization - The total value of all circulating tokens/shares, calculated as price \xD7 circulating supply.",
  ...
  FDV: {
    definition: "Fully Diluted Valuation - The theoretical market cap if all tokens were in circulation, calculated as price \xD7 total supply.",
  ...
  "SIGNAL COMBINATION": {
    definition: "Signal Combination - Using multiple technical indicators together to confirm trading decisions and improve accuracy. Single indicators can give false signals, but when 2-3 indicators align, the probability of success increases significantly.",
    howToUse: "\u{1F3AF} PROVEN MULTI-SIGNAL STRATEGIES:\n\n1. STRONG BUY Setup (80%+ accuracy):\n   \u2022 RSI <30 (oversold)\n   \u2022 MACD bullish crossover\n   \u2022 Price bouncing off support\n   \u2022 Volume spike (2x average)\n   \u2022 Price above EMA 200\n   = All 5 signals = High conviction buy\n\n2. STRONG SELL Setup:\n   \u2022 RSI >70 (overbought)\n   \u2022 MACD bearish crossover\n   \u2022 Price rejected at resistance\n   \u2022 Volume declining\n   \u2022 Price below EMA 50\n   = Exit or short position\n\n3. TREND CONFIRMATION (Stay in Trade):\n   \u2022 MACD above zero line\n   \u2022 RSI 50-70 range\n   \u2022 Price above EMA 50 & 200\n   \u2022 Volume steady or rising\n   = Strong uptrend, hold position\n\n4. WARNING - Exit Soon:\n   \u2022 RSI divergence (price up, RSI down)\n   \u2022 MACD histogram shrinking\n   \u2022 Volume declining on rallies\n   \u2022 Price approaching resistance\n   = Take profits, trend exhausting\n\n5. NO TRADE Zone (Wait):\n   \u2022 RSI 40-60 (neutral)\n   \u2022 MACD flat near zero\n   \u2022 Price between EMAs\n   \u2022 Low volume\n   = Consolidation, wait for clear setup\n\nRULE OF THUMB: Need at least 3 confirming signals for high-probability trades. 1-2 signals = too risky, often false."
  },
  SIGNALS: {
    definition: "Same as SIGNAL COMBINATION - see that entry for complete multi-signal trading strategies.",
    howToUse: "Type 'SIGNAL COMBINATION' to see proven strategies for combining RSI, MACD, Volume, Support/Resistance, and EMAs for higher accuracy trades."
  }
};
const glossaryTool = createTool({
  id: "glossary-tool",
  ...
  execute: async ({ context, mastra }) => {
    ...
    logger?.info("\u{1F527} [GlossaryTool] Looking up term", { term: context.term });
...
export { glossaryTool };
//# sourceMappingURL=28119917-213b-4ae2-a67b-f91db5e97838.mjs.map
