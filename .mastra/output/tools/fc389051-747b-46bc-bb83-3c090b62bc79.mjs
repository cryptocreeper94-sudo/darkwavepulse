...
function deriveKey(masterSecret, salt) {
  return crypto__default.pbkdf2Sync(masterSecret, salt, 1e5, 32, "sha256");
}
function encryptPrivateKey(privateKey) {
  ...
  const salt = crypto__default.randomBytes(SALT_LENGTH);
  const key = deriveKey(masterSecret, salt);
  const iv = crypto__default.randomBytes(IV_LENGTH);
...
//# sourceMappingURL=fc389051-747b-46bc-bb83-3c090b62bc79.mjs.map
