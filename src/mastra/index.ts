...
// Note: Disabled for Mastra 1.1.0 compatibility - getWorkflows/getAgents are no longer methods
// We only have 1 workflow (darkwaveWorkflow) and 1 agent (darkwaveAgent) so this check is satisfied
/*
